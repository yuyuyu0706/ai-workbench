...
| Prompt  | `scope: "global"` または `scope: "project"; projectId: ProjectId`、`title: string`、`body: string`、`kind: PromptKind`、`status: PromptStatus`、`tags: readonly string[]`、`variableValues: Record<string, string>`                                                                                                                                                                 |
...
| `saveRun`               | projects + prompts + recipes + runs     |
| `saveLink`              | runs + links                            |
| `insertTrailBundle`     | 6 Store すべて                          |
| `createDirectRunBundle` | projects + prompts + runs               |
