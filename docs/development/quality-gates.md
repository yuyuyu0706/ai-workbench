...
| ゲート               | 初動                                                                     | 再実行コマンド                                | 詳細診断                                                                      |
| -------------------- | ------------------------------------------------------------------------ | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Install dependencies | Node.js / pnpm version、lockfile 差分、registry 接続先を確認する。       | `pnpm install --frozen-lockfile`              | [Runtime / Install](troubleshooting.md#5-runtime--nodejs--pnpm--corepack)     |
