...
| 変数・タグ          | Phase 2でPrompt Editorおよび Prompt Library Popover（閲覧mode）上の`${varName}`変数検出・バッジ表示・コピー時置換UIを実装済み。P2-1-7でPrompt種別を廃止し、既存の種別値は対応する日本語ラベルとして`tags`へ移行した。タグの入力UI・表示・検索はP2-1-7-2以降で対応する                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
