...
| 作成・編集          | Phase 2でPrompt種別、タイトル、本文の順に入力し、Page Headerとform下部の同一formに接続された保存Actionから登録・更新できる。Prompt Editorのフィールドラベルは「種別」「タイトル」と表示し、種別とタイトルは横並びgridで配置する。Prompt本文ラベル右のコピーボタンでtextareaの現在入力値をクリップボードへコピーできる                                                                                                                                                                                                                                                                                                                                                                                                               |
