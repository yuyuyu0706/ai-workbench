...
| 機能                | 要件・Phase配置                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 一覧                | Phase 2でPrompt Libraryを実データへ接続し、compactなSemantic tableでPrompt名、Project、種別、更新日時、Prompt本文表示、操作を比較できる。Project Filterと検索後に、更新日時降順（既定）／Prompt名昇順／Prompt名降順を循環し、sort stateは永続化しない                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 作成・編集          | Phase 2でPrompt種別、タイトル、本文の順に入力し、Page Headerとform下部の同一formに接続された保存Actionから登録・更新できる。Prompt Editorのフィールドラベルは「種別」「タイトル」と表示し、種別とタイトルは横並びgridで配置する。Prompt本文ラベル右のコピーボタンでtextareaの現在入力値をクリップボードへコピーできる。本文に`${varName}`形式の変数プレースホルダーが検出されると、クリック不要で常に変数入力パネル（各変数のバッジ風ラベル＋入力欄）を表示する。パネル内に個別のコピーボタンは持たず、コピーはPrompt本文ラベル右の既存コピーボタンに一本化し、クリック時はパネルの現在値を使って置換・コピーする。未入力の変数は`${varName}`のままコピーされる。パネルの入力値は保存時に本文中の変数だけへ絞り込んでPromptへ永続化され、編集時は`prompt.variableValues`から初期値として復元される（新規作成時は空）。Prompt本文textareaは種別・タイトル欄（最大44rem）より横幅を広くとり、カード幅いっぱいまで拡大する                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 変数・タグ          | Phase 2でPrompt Editorおよび Prompt Library Popover（閲覧mode）上の`${varName}`変数検出・バッジ表示・コピー時置換UIを実装済み。高度な管理（タグ付け・検索・版管理との統合）はPhase 3で利用証拠に基づき判断する                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 復元・版管理        | 復元、ゴミ箱、更新履歴、過去版閲覧・比較・ロールバックはPhase 3候補とする                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 高度な検索          | タグ、種別、Status、全文検索、Prompt名以外の複数列Sort等はPhase 3候補とする                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
