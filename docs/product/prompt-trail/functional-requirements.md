...
| 機能                | 要件・Phase配置                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 一覧                | Phase 2でPrompt Libraryを実データへ接続し、compactなSemantic tableでPrompt名、Project、更新日時、Prompt本文表示、操作を比較できる（P2-1-7でPrompt種別列を廃止した）。Project Filterと検索後に、更新日時降順（既定）／Prompt名昇順／Prompt名降順を循環し、sort stateは永続化しない                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 簡易検索            | Phase 2で既存ScopeによるProject絞り込みとタイトル・本文のキーワード検索をAND合成する。全件数と表示件数を区別し、結果0件では条件変更と一括解除を案内する                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| 変数・タグ          | Phase 2でPrompt Editorおよび Prompt Library Popover（閲覧mode）上の`${varName}`変数検出・バッジ表示・コピー時置換UIを実装済み。P2-1-7でPrompt種別を廃止し、既存の種別値は対応する日本語ラベルとして`tags`へ移行した。P2-1-7-2でPrompt Editorにタグのchip入力UI（Enterで追加、×で削除、trim・24文字上限・10個上限・大文字小文字を無視した重複排除のvalidation付き）を実装し、Prompt Library Popover（閲覧mode）でタグを読み取り専用chipとして表示する（Popoverからのタグ編集は対象外）。タグの一覧列表示・検索・FilterはP2-1-7-3以降で対応する                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
