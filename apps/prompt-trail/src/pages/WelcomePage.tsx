const trailModels = [
  ...
  {
    name: 'Context',
    description: 'Issue、仕様、制約、判断材料など、依頼の背景をひとまとまりで扱います。',
  },
  {
    name: 'Recipe',
    description: '成果につながった依頼手順を、次回もたどれる作業テンプレートにします。',
  },
  {
    name: 'Run',
    description: '実行ごとの入力、結果、気づきを記録し、改善の履歴を追えるようにします。',
  },
  {
    name: 'Link',
    description: 'Chat、Issue、PR、成果物を結び、AI作業の流れを一本のTrailとして見返します。',
  },
];
  ...
  return (
    <main className="welcome-page" aria-labelledby="welcome-title">
      <section className="welcome-hero" aria-describedby="welcome-lead">
        ...
        <h1 id="welcome-title">AIへの依頼から成果までを、再利用できるTrailに。</h1>
      ...
      <section className="welcome-section" aria-labelledby="model-title">
        <div className="section-heading">
          ...
          <p>
            Phase 0では実データや操作機能を持たず、後続実装で扱う情報の単位を初期画面で共有します。
          </p>
        </div>
      ...
      <section className="welcome-grid" aria-label="PromptTrail assumptions and current phase">
        ...
        <article className="info-card phase-card">
          ...
          <p>
            この画面は、Router、状態管理、IndexedDB、CRUD、検索、AI実行をまだ含まない静的なWelcome Pageです。
